...
【エンゲージメント最大化ルール（Threads・Instagram共通）】
...
- 「稼げた」→「副業解禁3ヶ月で月5万」
- 「多い」→「8回連続で」
- 抽象的な表現を見つけたら必ず数字に置き換える

③失敗・成功・お金のどれかに必ず触れる
- 人が本能的に反応する3テーマ
- 「銀行員時代に損した話」「副業で初めて稼げた瞬間」「知らないと損するお金の話」

⑤誰×どこ×何したで書く
- 「誰が・どこで・何をしたか」が1文で分かる構造にする
- 「資産運用は大事」→「元銀行員の自分が、銀行を辞めた翌日にNISAを始めた」

⑩抽象を全部消して具体に振り切る
- 「頑張る」→「朝5時にPC開く」
- 「勉強する」→「毎朝30分ChatGPTと対話する」
- 「稼ぐ」→「Threadsの投稿1本で月3万の案件が来た」

■ 週2〜3回使う（強化オプション）

①感情を揺さぶるパワーワードを自然に1つ混ぜる
使っていいワード：「衝撃」「まさか」「ありえない」「正直」「やばい」「盲点だった」
※多用厳禁・1投稿1個まで

④冒頭1単語目に強い言葉を置く（週2〜3回）
使っていいワード：「暴露」「ガチで」「禁断」「実は」「盲点」「これ知らないと」
※毎回使うとスパムに見えるので週2〜3回のみ

⑧肩書き×行動のギャップを作る（週2〜3回）
- 「20年間リスク管理してきた元銀行員が、副業でAIに全ベットしてる」
- 「お客様にNISAを勧めてた側の人間が、自分はやってなかった」
- 真面目・堅い × AI・副業・発信 のギャップを積極的に使う

■ 月2〜3回使う（特効薬）

⑨お断り構文で対象を絞る
例）「副業に興味ない人は読まないでください」
例）「お金の話が嫌いな人にはきつい内容です」
※絞ることで刺さる人に深く届く

⑦五感・シーンを想起させる
「〇〇な場面が脳内再生される文」を書く
例）「深夜、布団でスマホ握りながら副業の売上確認してニヤけてる自分がいた」
例）「会社のトイレで、こっそりChatGPTに話しかけてた」

■ 絶対やってはいけないこと
- 全部のテクニックを1投稿に詰め込む（ごちゃごちゃになる）
- 「禁断」「未公開」を毎回使う（スパムに見える）
- 数字を盛る・嘘をつく（コンプライアンス違反）
